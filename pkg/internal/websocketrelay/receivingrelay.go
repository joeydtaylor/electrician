...
// ReceivingRelay implements a WebSocket relay server and forwards decoded items to submitters.
...
// NewReceivingRelay initializes a WebSocket receiving relay with optional configuration.
func NewReceivingRelay[T any](ctx context.Context, options ...types.Option[*ReceivingRelay[T]]) *ReceivingRelay[T] {
	...
	rr := &ReceivingRelay[T]{
		...
		componentMetadata: types.ComponentMetadata{
			...
			Type: "WEBSOCKET_RECEIVING_RELAY",
		},
