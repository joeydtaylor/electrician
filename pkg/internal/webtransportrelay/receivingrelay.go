...
// ReceivingRelay implements a WebTransport relay server and forwards decoded items to submitters.
...
// NewReceivingRelay initializes a WebTransport receiving relay with optional configuration.
func NewReceivingRelay[T any](ctx context.Context, options ...types.Option[*ReceivingRelay[T]]) *ReceivingRelay[T] {
	...
	rr := &ReceivingRelay[T]{
		...
		componentMetadata: types.ComponentMetadata{
			...
			Type: "WEBTRANSPORT_RECEIVING_RELAY",
		},
