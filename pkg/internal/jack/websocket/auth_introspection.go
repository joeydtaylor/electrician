...
func (s *serverAdapter[T]) ensureDefaultAuthValidatorLocked() {
	if s.dynamicAuthValidator != nil {
		return
	}
	if s.authOptions == nil || !s.authOptions.GetEnabled() || s.authOptions.Mode != relay.AuthMode_AUTH_OAUTH2 {
		return
	}
